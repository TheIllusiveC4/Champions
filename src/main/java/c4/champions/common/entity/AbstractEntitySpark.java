...
public abstract class AbstractEntitySpark extends Entity {
  ...
  public AbstractEntitySpark(World worldIn) {
    super(worldIn);
  ...
  public AbstractEntitySpark(World worldIn, double x, double y, double z, double motionXIn, double motionYIn, double motionZIn) {
    this(worldIn);
  ...
  public AbstractEntitySpark(World worldIn, EntityLivingBase ownerIn, Entity targetIn, EnumFacing.Axis directionIn) {
    this(worldIn);
    this.owner = ownerIn;
    ...
    if (!this.world.isRemote && this.world.getDifficulty() == EnumDifficulty.PEACEFUL) {
      ...
      if (!this.world.isRemote) {
        ...
        if (this.target == null || !this.target.isEntityAlive() || this.target instanceof EntityPlayer
            && ((EntityPlayer)this.target).isSpectator()) {
        ...
        RayTraceResult raytraceresult = ProjectileHelper
            .forwardsRaycast(this, true, false, this.owner);
      ...
      if (this.world.isRemote) {
        this.world.spawnParticle(
            this.getParticleType(), this.posX - this.motionX, this.posY - this.motionY +
  ...
  protected abstract void bulletHit(RayTraceResult result);
