...
public class EntityIsChampion implements LootItemCondition
{
    ...
    public static LootItemConditionType type = new LootItemConditionType(new EntityIsChampion.Serializer());
    ...
    private EntityIsChampion(
      @Nullable Integer minTier, @Nullable Integer maxTier,
    ...
    public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<EntityIsChampion>
    {
        ...
        @Override
        public void serialize(final JsonObject json, final EntityIsChampion value, final JsonSerializationContext context)
        {
