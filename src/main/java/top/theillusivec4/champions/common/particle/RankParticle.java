...
public class RankParticle extends TextureSheetParticle {
    ...
    private RankParticle(
            ClientLevel p_i51008_1_,
            double p_i51008_2_,
            double p_i51008_4_,
            double p_i51008_6_,
            double p_i51008_8_,
    ...
    public static class RankFactory implements ParticleProvider<SimpleParticleType> {

        private final SpriteSet spriteSet;

        public RankFactory(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }
        ...
        public Particle createParticle(
            ...
            RankParticle rankParticle = new RankParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
